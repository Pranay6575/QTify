  ...
  return (
    <>
      ...
      <div className={styles.SectionWrapper}>
        ...
        <hr className={styles.HrLine} style={{ background: '#34C94B',color: '#34C94B', borderColor: '#34C94B', height: '1px'}}/>
        ...
        <hr className={styles.HrLine} style={{ background: 'lime',color: 'lime', borderColor: 'lime', height: '1px'}}/>
        <AccordionSection/>       
      </div>
    </>
  );
